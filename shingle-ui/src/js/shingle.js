...
angular.module('shingle', []).config(function ($locationProvider) {
...
angular.module('shingle').controller('ShingleController', function ($scope, $http, $sce, $location, $timeout) {
...
angular.module('shingle').directive('shingleModel', function ($sce) {
    return {
        restrict: 'A',

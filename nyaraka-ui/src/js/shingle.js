...
angular.module('nyaraka', []).config(function ($locationProvider) {
...
angular.module('nyaraka').controller('NyarakaController', function ($scope, $http, $sce, $location, $timeout) {
...
angular.module('nyaraka').filter('objectName', function () {
    return function (id) {
        if (!id) {
            return 'Object';
        }
...
angular.module('nyaraka').directive('nyarakaToggle', function () {
    return {
        restrict: 'A',
        scope: {
            hidden: '=nyarakaToggle'
        },
...
angular.module('nyaraka').directive('nyarakaModel', function ($sce) {
    return {
        restrict: 'A',

...
import org.shingle.Extension;
import org.shingle.Shingle;
import org.shingle.annotations.UniqueIdentifier;
...
public class DocumentationBuilderTest {
    ...
    public void should_exclude_some_classes_from_documentation() throws Exception {
        ...
        Shingle shingle = Shingle.builder()
    ...
    public void should_only_create_documentation_for_method_with_annotation_HttpMethod() throws Exception {
        ...
        Shingle shingle = Shingle.builder().build();
        DocumentationBuilder documentationBuilder = new DocumentationBuilder(shingle, "1.0");
    ...
    public void should_prepend_basepath_to_path_of_method() throws Exception {
        ...
        Shingle shingle = Shingle.builder().basePath("myBasePath").build();
        DocumentationBuilder documentationBuilder = new DocumentationBuilder(shingle, "1.0");
    ...
    public void should_not_prepend_null_basepath_to_path() throws Exception {
        ...
        List<Class<?>> classes = singletonList(Aaa.class);
        Shingle shingle = Shingle.builder().basePath(null).build();
        DocumentationBuilder documentationBuilder = new DocumentationBuilder(shingle, "1.0");
    ...
    public void should_handle_classical_parameters() throws Exception {
        ...
        // Then
        assertThat(parameters).extracting(p -> p.type).containsOnly(Parameter.Type.path, Parameter.Type.query, Parameter.Type.header, Parameter.Type.cookie, Parameter.Type.form, Parameter.Type.matrix);
    ...
    public void should_handle_bean_parameters() throws Exception {
        ...
        assertThat(parameters).extracting(p -> p.type).containsOnly(Parameter.Type.query, Parameter.Type.header, Parameter.Type.form, Parameter.Type.path);
    }
    ...
    public void should_handle_body_parameter() throws Exception {
        ...
        assertThat(parameters).extracting(p -> p.type).containsOnly(Parameter.Type.body);
    }
    ...
    public void should_handle_body_parameter_with_classical_parameters() throws Exception {
        ...
        assertThat(parameters).extracting(p -> p.type).containsOnly(Parameter.Type.body, Parameter.Type.path);
    }
    ...
    public void should_add_method_return_types_in_resource_outputs() throws Exception {
        ...
        assertThat(responses).extracting(this::convert)
                             .contains("{\"type\":\"object\",\"id\":\"urn:jsonschema:org:shingle:jaxrs:DocumentationBuilderTest:2MyBean\",\"properties\":{\"myField\":{\"type\":\"string\"}}}");
    }
    ...
    public void should_remove_default_response_when_other_response_is_present() throws Exception {
        ...
        Shingle shingle = Shingle.builder().extension(new MyExt()).build();
        DocumentationBuilder documentationBuilder = new DocumentationBuilder(shingle, "1.0");
    ...
    public void should_handle_extensions() throws Exception {
        ...
        Shingle shingle = Shingle.builder().extension(new Extension() {
            @Override
            public void enrich(Method method, Resource.ResourceBuilder resourceBuilder, Shingle shingle) {

...
import org.shingle.annotations.ApiResponse;
...
public class ShingleExtensionTest {
    ...
    public void api_response_on_method_replaces_status_code() throws Exception {
        ...
        assertThat(resource.outputs).extracting(r -> r.contentTypes).containsOnly(asList("application/shingle"));
    }
    ...
    public void should_remove_default_response_when_other_response_is_present() throws Exception {
        ...
        List<org.shingle.model.Response> responses = documentation.getResources()
                                                                  .stream()
